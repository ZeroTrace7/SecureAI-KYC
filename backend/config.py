...
WEIGHT_VOICE = float(os.getenv("WEIGHT_VOICE", "0.05"))
WEIGHT_SIGNATURE_SEAL = float(os.getenv("WEIGHT_SIGNATURE_SEAL", "0.12"))
WEIGHT_TEXT_INTEGRITY = float(os.getenv("WEIGHT_TEXT_INTEGRITY", "0.10"))
WEIGHT_BLOCKCHAIN = float(os.getenv("WEIGHT_BLOCKCHAIN", "0.08"))

# ─── Feature Flags ────────────────────────────────────────
# Toggle optional / risky features
ENABLE_VOICE = os.getenv("ENABLE_VOICE", "false").lower() == "true"
ENABLE_ML_FORGERY = os.getenv("ENABLE_ML_FORGERY", "true").lower() == "true"
