...
MIN_RESOLUTION = int(os.getenv("MIN_RESOLUTION", "500"))
...
ELA_THRESHOLD = float(os.getenv("ELA_THRESHOLD", "0.35"))
DEEPFAKE_THRESHOLD = float(os.getenv("DEEPFAKE_THRESHOLD", "0.5"))
FRAUD_SCORE_THRESHOLD = float(os.getenv("FRAUD_SCORE_THRESHOLD", "60"))
NAME_MATCH_THRESHOLD = int(os.getenv("NAME_MATCH_THRESHOLD", "85"))

# ─── Fraud Signal Weights (must sum to 1.0) ──────────────
# QR-OCR mismatch is the strongest, most unique signal
WEIGHT_QR_OCR_MISMATCH = float(os.getenv("WEIGHT_QR_OCR_MISMATCH", "0.35"))
WEIGHT_ELA = float(os.getenv("WEIGHT_ELA", "0.25"))
WEIGHT_EXIF = float(os.getenv("WEIGHT_EXIF", "0.15"))
WEIGHT_DEEPFAKE = float(os.getenv("WEIGHT_DEEPFAKE", "0.10"))
WEIGHT_ML_FORGERY = float(os.getenv("WEIGHT_ML_FORGERY", "0.05"))
WEIGHT_VOICE = float(os.getenv("WEIGHT_VOICE", "0.10"))
